    ...
    <section className="mentor-section">
      <div className="mentor-container">
        ...
        <div className="mentor-content">
          ...
          <button className="mentor-button" onClick={() => window.open("https://live.skillsfavour.com/payment-link/68fc8be867ee3b46ba6a357c", "_blank")} >Enroll Now For Just ₹49!</button>
        </div>
      </div>
    </section>
  );
